          ...
          {tiers.map((tier, i) => (
            <div key={i} className={`p-6 flex flex-col items-center text-center transition-all border border-zinc-100 dark:border-zinc-800 ${tier.color}`}>
              ...
              <Link 
                ...
                className={`w-full py-3 md:py-4 font-black uppercase tracking-widest text-[9px] md:text-[10px] transition-all flex items-center justify-center gap-2 ${
              ...
              >
                {tier.button} <ChevronRight size={12} />
              </Link>
            </div>
          ))}
        </div>
