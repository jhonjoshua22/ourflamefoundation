...
interface FlameGameItem {
  ...
  reach_count: number;
  engagement: number; // Added to match your .tsx aggregations
  paid: number;       // Added to match your .tsx aggregations
  saved: number;      // Added to match your .tsx aggregations
  value: number;      // Added to match your .tsx aggregations
  description: string;
  is_active: boolean;
}
